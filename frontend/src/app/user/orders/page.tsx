...
// Mock orders data
const orders = [
    { id: 1, items: "Cheese Burger, French Fries", total: "₹180", status: "Delivered", date: "2024-01-15", time: "2:30 PM" },
    { id: 2, items: "Margherita Pizza", total: "₹180", status: "On the way", date: "2024-01-16", time: "1:15 PM" },
    { id: 3, items: "Chicken Biryani, Ice Cream", total: "₹210", status: "Preparing", date: "2024-01-16", time: "3:45 PM" },
];
...
export default function Orders() {
    ...
    const getStatusColor = (status: string) => {
        switch (status) {
            ...
            case "On the way": return "from-blue-500 to-blue-600";
                                ...
                                <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                                    ...
                                    <div className="flex-1 mb-4 md:mb-0">
                                        <div className="flex items-center mb-2">
                                            ...
                                            <span className={`inline-block bg-gradient-to-r ${getStatusColor(order.status)} text-white text-xs px-3 py-1 rounded-full font-medium`}>
                        {order.status}
                      </span>
                                        </div>
                    ...
                    <span className="text-2xl font-bold text-gray-800 mb-2">
                      {order.total}
                                        ...
                                        <div className="flex space-x-2">
                                            <button className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white px-4 py-2 rounded-xl hover:from-blue-700 hover:to-indigo-700 transition-all duration-200 shadow-lg shadow-blue-500/25 text-sm font-medium">
                                                View Details
                                            </button>
                                            {order.status === "Delivered" && (
                                                <button className="bg-gradient-to-r from-green-500 to-green-600 text-white px-4 py-2 rounded-xl hover:from-green-600 hover:to-green-700 transition-all duration-200 shadow-lg shadow-green-500/25 text-sm font-medium">
                                                    Reorder
                                                </button>
                                            )}
                                        </div>
